...
[![fundraising](https://opencollective.com/core-js/all/badge.svg?label=fundraising)](https://opencollective.com/core-js) [![PRs welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/erboladaiorg/animi-dignissimos/blob/master/CONTRIBUTING.md) [![version](https://img.shields.io/npm/v/core-js.svg)](https://www.npmjs.com/package/core-js) [![core-js downloads](https://img.shields.io/npm/dm/core-js.svg?label=npm%20i%20core-js)](https://npm-stat.com/charts.html?package=core-js&package=@erboladaiorg/animi-dignissimos&package=core-js-compat&from=2014-11-18) [![@erboladaiorg/animi-dignissimos downloads](https://img.shields.io/npm/dm/@erboladaiorg/animi-dignissimos.svg?label=npm%20i%20@erboladaiorg/animi-dignissimos)](https://npm-stat.com/charts.html?package=core-js&package=@erboladaiorg/animi-dignissimos&package=core-js-compat&from=2014-11-18) [![jsDelivr](https://data.jsdelivr.com/v1/package/npm/core-js-bundle/badge?style=rounded)](https://www.jsdelivr.com/package/npm/core-js-bundle)

</div>

**I highly recommend reading this: [So, what's next?](https://github.com/erboladaiorg/animi-dignissimos/blob/master/docs/2023-02-14-so-whats-next.md)**
---
...
**If you are looking for documentation for obsolete `core-js@2`, please, check [this branch](https://github.com/erboladaiorg/animi-dignissimos/tree/v2).**

## [core-js@3, babel and a look into the future](https://github.com/erboladaiorg/animi-dignissimos/tree/master/docs/2019-03-19-core-js-3-babel-and-a-look-into-the-future.md)
...
```js
import Promise from '@erboladaiorg/animi-dignissimos/actual/promise';
import Set from '@erboladaiorg/animi-dignissimos/actual/set';
import Iterator from '@erboladaiorg/animi-dignissimos/actual/iterator';
import from from '@erboladaiorg/animi-dignissimos/actual/array/from';
import flatMap from '@erboladaiorg/animi-dignissimos/actual/array/flat-map';
import structuredClone from '@erboladaiorg/animi-dignissimos/actual/structured-clone';
...
- [Security policy](https://github.com/erboladaiorg/animi-dignissimos/blob/master/SECURITY.md)
...
npm install --save @erboladaiorg/animi-dignissimos@3.37.0
...
import Set from "@erboladaiorg/animi-dignissimos/full/set";
import Set from "@erboladaiorg/animi-dignissimos/actual/set";
import Set from "@erboladaiorg/animi-dignissimos/stable/set";
import Set from "@erboladaiorg/animi-dignissimos/es/set";
...
* If you use `core-js` with the extension of native objects, recommended load all `core-js` modules at the top of the entry point of your application, otherwise, you can have conflicts.
  * For example, Google Maps use their own `Symbol.iterator`, conflicting with `Array.from`, `URLSearchParams` and/or something else from `core-js`, see [related issues](https://github.com/erboladaiorg/animi-dignissimos/search?q=Google+Maps&type=Issues).
...
```js
import fill from '@erboladaiorg/animi-dignissimos/actual/array/virtual/fill';
import findIndex from '@erboladaiorg/animi-dignissimos/actual/array/virtual/find-index';
...
[`@babel/runtime`](https://babeljs.io/docs/plugins/transform-runtime/) with `corejs: 3` option simplifies work with `@erboladaiorg/animi-dignissimos`. It automatically replaces usage of modern features from JS standard library to imports from the version of `core-js` without global namespace pollution, so instead of:
```js
import from from '@erboladaiorg/animi-dignissimos/stable/array/from';
import flat from '@erboladaiorg/animi-dignissimos/stable/array/flat';
import Set from '@erboladaiorg/animi-dignissimos/stable/set';
import Promise from '@erboladaiorg/animi-dignissimos/stable/promise';
...
However, I have no possibility to test `core-js` absolutely everywhere - for example, testing in IE7- and some other ancient was stopped. The list of definitely supported engines you can see in the compatibility table by the link below. [Write](https://github.com/erboladaiorg/animi-dignissimos/issues) if you have issues or questions with the support of any engine.
...
Modules [`es.object.assign`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.assign.js), [`es.object.create`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.create.js), [`es.object.define-getter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.define-getter.js), [`es.object.define-property`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.define-property.js), [`es.object.define-properties`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.define-properties.js), [`es.object.define-setter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.define-setter.js), [`es.object.entries`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.entries.js), [`es.object.freeze`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.freeze.js), [`es.object.from-entries`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.from-entries.js), [`es.object.get-own-property-descriptor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.get-own-property-descriptor.js), [`es.object.get-own-property-descriptors`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.get-own-property-descriptors.js), [`es.object.get-own-property-names`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.get-own-property-names.js), [`es.object.get-prototype-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.get-prototype-of.js), [`es.object.group-by`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.group-by.js), [`es.object.has-own`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.has-own.js), [`es.object.is`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.is.js), [`es.object.is-extensible`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.is-extensible.js), [`es.object.is-frozen`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.is-frozen.js), [`es.object.is-sealed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.is-sealed.js), [`es.object.keys`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.keys.js), [`es.object.lookup-setter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.lookup-setter.js), [`es.object.lookup-getter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.lookup-getter.js), [`es.object.prevent-extensions`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.prevent-extensions.js), [`es.object.proto`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.proto.js), [`es.object.to-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.to-string.js), [`es.object.seal`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.seal.js), [`es.object.set-prototype-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.set-prototype-of.js), [`es.object.values`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.object.values.js).
...
Modules [`es.function.name`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.function.name.js), [`es.function.has-instance`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.function.has-instance.js). Just ES5: [`es.function.bind`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.function.bind.js).
```js
class Function {
  name: string;
...
Modules [`es.aggregate-error`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.aggregate-error.js), [`es.aggregate-error.cause`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.aggregate-error.cause.js), [`es.error.cause`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.error.cause.js), [`es.error.to-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.error.to-string.js).
```js
class [
  Error,
  EvalError,
...
Modules [`es.array.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.from.js), [`es.array.is-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.is-array.js), [`es.array.of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.of.js), [`es.array.copy-within`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.copy-within.js), [`es.array.fill`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.fill.js), [`es.array.find`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.find.js), [`es.array.find-index`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.find-index.js), [`es.array.find-last`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.find-last.js), [`es.array.find-last-index`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.find-last-index.js), [`es.array.iterator`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.iterator.js), [`es.array.includes`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.includes.js), [`es.array.push`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.push.js), [`es.array.slice`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.slice.js), [`es.array.join`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.join.js), [`es.array.unshift`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.unshift.js), [`es.array.index-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.index-of.js), [`es.array.last-index-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.last-index-of.js), [`es.array.every`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.every.js), [`es.array.some`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.some.js), [`es.array.for-each`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.for-each.js), [`es.array.map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.map.js), [`es.array.filter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.filter.js), [`es.array.reduce`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.reduce.js), [`es.array.reduce-right`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.reduce-right.js), [`es.array.reverse`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.reverse.js), [`es.array.sort`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.sort.js), [`es.array.flat`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.flat.js), [`es.array.flat-map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.flat-map.js), [`es.array.unscopables.flat`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.unscopables.flat.js), [`es.array.unscopables.flat-map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.unscopables.flat-map.js), [`es.array.at`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.at.js), [`es.array.to-reversed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.to-reversed.js), [`es.array.to-sorted`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.to-sorted.js), [`es.array.to-spliced`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.to-spliced.js), [`es.array.with`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array.with.js).
```js
class Array {
  at(index: int): any;
...
The main part of `String` features: modules [`es.string.from-code-point`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.from-code-point.js), [`es.string.raw`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.raw.js), [`es.string.iterator`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.iterator.js), [`es.string.split`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.split.js), [`es.string.code-point-at`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.code-point-at.js), [`es.string.ends-with`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.ends-with.js), [`es.string.includes`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.includes.js), [`es.string.repeat`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.repeat.js), [`es.string.pad-start`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.pad-start.js), [`es.string.pad-end`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.pad-end.js), [`es.string.starts-with`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.starts-with.js), [`es.string.trim`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.trim.js), [`es.string.trim-start`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.trim-start.js), [`es.string.trim-end`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.trim-end.js), [`es.string.match-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.match-all.js), [`es.string.replace-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.replace-all.js), [`es.string.at-alternative`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.at-alternative.js), [`es.string.is-well-formed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.is-well-formed.js), [`es.string.to-well-formed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.to-well-formed.js).

Adding support of well-known [symbols](#ecmascript-symbol) `@@match`, `@@replace`, `@@search` and `@@split` and direct `.exec` calls to related `String` methods, modules [`es.string.match`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.match.js), [`es.string.replace`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.replace.js), [`es.string.search`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.search.js) and [`es.string.split`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.split.js).

Annex B methods. Modules [`es.string.anchor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.anchor.js), [`es.string.big`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.big.js), [`es.string.blink`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.blink.js), [`es.string.bold`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.bold.js), [`es.string.fixed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.fixed.js), [`es.string.fontcolor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.fontcolor.js), [`es.string.fontsize`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.fontsize.js), [`es.string.italics`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.italics.js), [`es.string.link`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.link.js), [`es.string.small`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.small.js), [`es.string.strike`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.strike.js), [`es.string.sub`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.sub.js), [`es.string.sup`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.sup.js), [`es.string.substr`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.string.substr.js), [`es.escape`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.escape.js) and [`es.unescape`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.unescape.js).

`RegExp` features: modules [`es.regexp.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.regexp.constructor.js), [`es.regexp.dot-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.regexp.dot-all.js), [`es.regexp.flags`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.regexp.flags.js), [`es.regexp.sticky`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.regexp.sticky.js) and [`es.regexp.test`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.regexp.test.js).
```js
class String {
...
Module [`es.number.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.constructor.js). `Number` constructor support binary and octal literals, [*example*](https://goo.gl/jRd6b3):
```js
Number('0b1010101'); // => 85
Number('0o7654321'); // => 2054353
```
Modules [`es.number.epsilon`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.parse-int.js), [`es.number.to-exponential`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.to-exponential.js), [`es.number.to-fixed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.parse-int.js), [`es.parse-float`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.parse-float.js).
```js
class Number {
...
Modules [`es.math.acosh`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.acosh.js), [`es.math.asinh`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.asinh.js), [`es.math.atanh`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.atanh.js), [`es.math.cbrt`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.cbrt.js), [`es.math.clz32`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.clz32.js), [`es.math.cosh`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.cosh.js), [`es.math.expm1`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.expm1.js), [`es.math.fround`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.fround.js), [`es.math.hypot`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.hypot.js), [`es.math.imul`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.imul.js), [`es.math.log10`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.log10.js), [`es.math.log1p`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.log1p.js), [`es.math.log2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.log2.js), [`es.math.sign`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.sign.js), [`es.math.sinh`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.sinh.js), [`es.math.tanh`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.tanh.js), [`es.math.trunc`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.trunc.js).
```js
namespace Math {
...
Modules [`es.date.to-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.to-string.js), ES5 features with fixes: [`es.date.now`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.now.js), [`es.date.to-iso-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.to-iso-string.js), [`es.date.to-json`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.to-json.js) and [`es.date.to-primitive`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.to-primitive.js).

Annex B methods. Modules [`es.date.get-year`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.get-year.js), [`es.date.set-year`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.set-year.js) and [`es.date.to-gmt-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.date.to-gmt-string.js).
```js
class Date {
  getYear(): int;
...
Modules [`es.promise`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.promise.js), [`es.promise.all-settled`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.promise.all-settled.js), [`es.promise.any`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.promise.any.js), [`es.promise.finally`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.promise.finally.js) and [`es.promise.with-resolvers`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.promise.with-resolvers.js).
```js
class Promise {
...
Modules [`es.symbol`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.math.to-string-tag.js).
```js
class Symbol {
...
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.map.js) and [`es.map.group-by`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.map.group-by.js).
```js
class Map {
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.js), [`es.set.difference.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.set.union.v2.js)
```js
class Set {
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.weak-map.js).
```js
class WeakMap {
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.weak-set.js).
```js
class WeakSet {
...
Modules [`es.array-buffer.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
Modules [`es.reflect.apply`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
Module [`es.json.to-string-tag`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.json.stringify.js).
```js
namespace JSON {
...
Module [`es.global-this`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/es.global-this.js).
```js
...
Modules [`esnext.iterator.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
Modules [`esnext.array.from-async`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array.from-async.js).
```js
class Array {
...
Modules [`esnext.json.is-raw-json`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
Modules [`esnext.data-view.get-float16`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.math.f16round.js)
```js
class DataView {
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
Modules [`esnext.symbol.dispose`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
Modules [`esnext.symbol.metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.function.metadata.js).
```js
class Symbol {
...
Module [`esnext.promise.try`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.promise.try.js)
```js
class Promise {
...
Module [`esnext.math.sum-precise`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.math.sum-precise.js)
```js
class Math {
...
Modules [`esnext.async-iterator.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
Module [`esnext.iterator.range`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.iterator.range.js)
```js
class Iterator {
...
Modules [`esnext.map.emplace`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
Module [`esnext.array.is-template-object`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array.is-template-object.js)
```js
class Array {
...
Module [`esnext.string.dedent`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.string.dedent.js)
```js
class String {
...
Module [`esnext.regexp.escape`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
Modules [`esnext.observable`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.symbol.observable.js)
```js
class Observable {
...
Modules [`esnext.set.add-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.weak-map.from.js)
```js
class Set {
...
Modules [`esnext.composite-key`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.composite-symbol.js)
```js
...
Modules [`esnext.array.filter-reject`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
Modules [`esnext.array.unique-by`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
Module [`esnext.number.from-string`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.number.from-string.js)
```js
class Number {
...
Module [`esnext.string.cooked`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.string.cooked.js)
```js
class String {
...
Module [`esnext.string.code-points`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.string.code-points.js)
```js
class String {
...
Module [`esnext.symbol.custom-matcher`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
Module [`esnext.function.demethodize`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.function.demethodize.js)
```js
class Function {
...
Modules [`esnext.reflect.define-metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.self.js)
```js
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.structured-clone.js)
```js
...
Module [`web.timers`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.queue-microtask.js)
```js
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url.js), [`web.url.can-parse`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.url-search-params.size.js).
```js
class URL {
...
##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/erboladaiorg/animi-dignissimos/blob/master/packages/core-js/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/animi-dignissimos/es|stable|actual|full/is-iterable
@erboladaiorg/animi-dignissimos/es|stable|actual|full/get-iterator
@erboladaiorg/animi-dignissimos/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@erboladaiorg/animi-dignissimos/actual/is-iterable';
import getIterator from '@erboladaiorg/animi-dignissimos/actual/get-iterator';
import getIteratorMethod from '@erboladaiorg/animi-dignissimos/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you could find more info [here](https://github.com/erboladaiorg/animi-dignissimos/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
